...
class DialogTestComprehension extends StatelessWidget {
  final Map<String, Object> data;
  int index;
  double completed;
  final void Function(bool) onPressed;

  DialogTestComprehension({this.data, this.index, this.completed, this.onPressed});
              ...
              Center(
                child: Column(
                  children: <Widget>[
                    ...
                    DialogCreateButtons(
                        data: this._createListAlternatives(), correct: this.data['correct'], onPressed: this.onPressed),
                    SizedBox(
                      height: 50,
                    ),
                  ],
